...
def create_resources(sdn_repo: SdnReourcesRepo, vm_repo: VirtualMachinesRepo):
    irt_10_10_12_0_24 = sdn_repo.create_interface_route_table(
        fq_name=fq_name("irt-10-10-12-0_24"),
        prefix_list=["10.10.1.0/24", "10.10.2.0/24"],
    )
    irt_10_10_3_0_24 = sdn_repo.create_interface_route_table(
        fq_name=fq_name("irt-10-10-3-0_24"),
        prefix_list=["10.10.3.0/24"],
    )
    ...
    vmi_2_11 = sdn_repo.create_virtual_machine_interface(
        ...
        virtual_network=vn_2,
        interface_route_table=irt_10_10_3_0_24,
    )
    sdn_repo.create_instance_ip(
    ...
    vmi_3_11 = sdn_repo.create_virtual_machine_interface(
        ...
        virtual_network=vn_3,
        interface_route_table=irt_10_10_12_0_24,
    )
    sdn_repo.create_instance_ip(
    ...
    sdn_repo.create_logical_router(
        ...
        logical_router_type=constants.LogicalRouterType.VXLAN,
    )
...
# ./controller-routes.py -c configs/dev.ini int-rt-vxlan -f evpn
